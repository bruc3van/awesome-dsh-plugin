...
- **[dsh-canvas-preview](https://github.com/jiuyuechuwuhao/dsh-canvas-preview)** ([@jiuyuechuwuhao](https://github.com/jiuyuechuwuhao) · 2026-08-17) — Adds a Canvas tab to DSH sessions: live-preview workspace HTML artifacts and export PNG/JPG/SVG locally. For people who generate diagrams, infographics, or HTML mockups. Does not upload artifacts.
