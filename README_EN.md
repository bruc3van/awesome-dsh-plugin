...
- **[dsh-movein](https://github.com/sjh9714/dsh-movein)** ([@sjh9714](https://github.com/sjh9714) · 2026-08-16) - Previews and moves supported Claude Code, Codex, and OpenCode setup into DSH. It covers skills, commands, agents, instructions, and local or remote MCP servers, supports OpenCode V1/V2 JSONC precedence, and preserves environment placeholders. Unsupported semantics are reported instead of guessed, while destination collision checks, backups, restore, and `doctor` diagnostics remain available.
