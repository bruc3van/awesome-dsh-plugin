...
- **[SandBase Skills](https://github.com/sandbaseai/sandbase-skills)** ([@sandbaseai](https://github.com/sandbaseai) · 2026-08-19) — Provides 88 Agent Skills for research, social intelligence, marketing, and business workflows; the native DSH bundle mounts the full catalog, while multi-source-search can be installed alone with an offline evidence-ledger validator.
