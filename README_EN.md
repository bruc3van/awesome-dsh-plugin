...
- **[dsh-win32](https://github.com/sjh9714/dsh-win32)**（[@sjh9714](https://github.com/sjh9714) · 2026-08-16）— Get DSH working on Windows: supplies the missing win32 ProcessInspector so Minimal mode's persistent shell starts, plus a busybox variant that survives the workspace-write sandbox, ConPTY foreground resolution, GBK/UTF-16 reads and a `doctor` preflight.
