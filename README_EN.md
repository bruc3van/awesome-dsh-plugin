...
- **[dsh-whale-meter](https://github.com/Shiye-10Pages/dsh-whale-meter)** ([@Shiye-10Pages](https://github.com/Shiye-10Pages) · 2026-08-17) — Usage ledger and stats card: 🐟→🐳 tiers by monthly token burn, with a percentile estimated locally from a distribution curve committed in the repo (nothing is uploaded; the UI labels it an estimate rather than a global ranking); 46 models across 6 vendors checked against official pricing pages, including size-tiered Chinese pricing (GLM-5.1 is ¥6/M under 32K input, ¥8/M above); backfills sessions from before install; prices are organised by effective period so usage before and after the 2026-08-17 change bills at its own rates. For people who want to know what they actually burned without handing the numbers to anyone.
