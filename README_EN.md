...
- **[dsh-self-evolving](https://github.com/timwhitez/dsh-self-evolving)** ([@timwhitez](https://github.com/timwhitez) · 2026-08-16) — Evidence-first, crash-resumable self-evolution engine for DSH: generates bounded Cordis plugin candidates, admits them through a one-shot real Loader, evaluates with Harbor, and keeps an auditable journaled lineage; 291 unit + 36 Loader E2E tests. For DSH users who want a self-improvement loop they can audit (no Terminal-Bench improvement is claimed).
