...
| Move a whole Claude Code setup into DSH | [dsh-movein](https://github.com/sjh9714/dsh-movein) | One command moves skills, MCP servers, hooks, subagents and permission rules, dry-run moving estimate first, migration diff report for permission rules. CLAUDE.md needs no move, DSH reads it natively. |
