...
<!-- dsh:panorama:start -->
截至 2026-08-26 共收录 **10137** 个经核实的仓库。它们长这样：
...
截至 2026-08-26，全量目录收录 **10137** 个仓库、**30** 种主要语言；其中 **9017** 个声明了许可证，**10106** 个未归档且未禁用（目录随人工审核合并更新，最新统计以 [CATALOG.md](./CATALOG.md) 为准）。
