...
- **[dsh-canvas-preview](https://github.com/jiuyuechuwuhao/dsh-canvas-preview)**（[@jiuyuechuwuhao](https://github.com/jiuyuechuwuhao) · 2026-08-17）— 给 DSH 会话加上「画板」页签：实时预览工作区 HTML 产物并在本机导出 PNG/JPG/SVG。适合做架构图、信息图、网页原型的人。不把产物发到第三方。
