...
- **[dsh-win32](https://github.com/sjh9714/dsh-win32)**（[@sjh9714](https://github.com/sjh9714) · 2026-08-16）— 在 Windows 上把 DSH 用起来：补上官方缺的 win32 ProcessInspector，让极简模式的持久 shell 能起来；另有沙箱内可用的 busybox 变体、ConPTY 前台命令识别、GBK/UTF-16 读取与 `doctor` 安装体检。
