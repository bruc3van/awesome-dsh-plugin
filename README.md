...
- **[dsh-wm](https://github.com/WayneJin0918/dsh-wm)**（[@WayneJin0918](https://github.com/WayneJin0918) · 2026-08-17）— DeepSeek Harness 上的世界模型研究插件：看帧、认 3D / pixel / latent 路线、给 pred vs GT 打分，并对 skill / wm.yaml 做 RSI。
