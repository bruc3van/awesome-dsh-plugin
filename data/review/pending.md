...
对比上一份快照 **2026-08-25** / vs previous snapshot **2026-08-25**。规则：日增 ≥100★；已核准仓新入 Top 200（且 Δ≥50）/ 名次跃升 ≥50 / 冲入 Top 20；待审仓 ≥100★ 且核准后将进入 Top 200。
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| ⚠️ [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | 已核准 / approved | 20331 | +209 | 991 | 12d | 日增百星 | 日增 +209★ |
| ⚠️ [shaobeichen/dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 已核准 / approved | 667 | +28 | 37 | 10d | 冲入 Top 20 | 冲入 Top 20（21→20） |
